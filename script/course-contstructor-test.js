    ...
    $(document).ready(function () {
        ...
        $('.content-container').on('click', '.add-chapter-constructor', function () {
            ...
            if(block && blockItem){
                ...
                '               <input type="text" class="answer input-shdw" value="" placeholder="«Название»" id="chapter_' + section + '" name="chapter_' + section + '">' +
                '              </div>' +
        ...
        function AddNewChapterAjax(block, blockItem, section, thisEl, chapterId){
            ...
            '             <div class="title">' +
            '               <span>Раздел ' + section + ': </span>' +
            '               <input type="text" class="answer input-shdw" value="" placeholder="«Название»" id="chapter_' + block + '_' + blockItem + '_' + chapterId + '_' + section +  '" name="chapter_' + block + '_' + blockItem + '_' + chapterId + '_' + section +  '">' +
            '              </div>' +
            '              <div class="delete-chapter-cont">' +
            ...
            if(nameQuestion[1] && nameQuestion[2]  && nameQuestion[3]  && nameQuestion[4]){
                ...
                if ($(this).val() == 2) {
                    newQuestion =
                        ...
                        '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" name="questionscaledescr_' + section + '_' + question + '_1" id="questionscaledescr_' + section + '_' + question + '_1">' +
                        ...
                        '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" name="questionscaledescr_' + section + '_' + question + '_2" id="questionscaledescr_' + section + '_' + question + '_2">' +
        ...
        function changeTypeOfQuestionAjax(block,blockItem,section, question, items, thisEl){
            ...
            if ($(thisEl).val() == 2) {
                newQuestion =
                    ...
                    '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" id="questionscaledescr_' + block + '_' + blockItem + '_' + section + '_' + question + '_'+ items[0] +'" name="questionscaledescr_' + block + '_' + blockItem + '_' + section + '_' + question + '_'+ items[0] +'">' +
                    ...
                    '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" name="questionscaledescr_' + block + '_' + blockItem + '_' + section + '_' + question + '_'+ items[1] +'" id="questionscaledescr_' + block + '_' + blockItem + '_' + section + '_' + question + '_'+ items[1] +'">' +
