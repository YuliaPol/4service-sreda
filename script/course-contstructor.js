jQuery(function ($) {
    $(document).ready(function () {
        ...
        function addItemCourseTest(section, question, item, thisEl, chapterId, questionId, itemId){
            ...
            '        <input id="filename_' + chapterId + '_' + questionId + '_' + itemId + '" type="file" name="filename_' + chapterId + '_' + questionId + '_' + itemId + '" class="test-answer">'+
            '        <label for="filename_' + chapterId + '_' + questionId + '_' + itemId + '"><img class="upload-image" src="../../../img/corp/icons/download-arrow_blue.png"></label>'+
            '    </div>'+
        ...
        function addQuestionTestCourse(section, chaterId, question, items, qustionId, thisEl){
            ...
            '        </div>' +
            '        <div class="input-group">' +
            '            <input type="text" placeholder="Описание вопроса (необязательно)" class="input-shdw"  id="questiondescription_' + chaterId + '_' + qustionId + '" name="questiondescription_' + chaterId + '_' + qustionId + '">' +
            '        </div>' +
            '    </div>' +
            '    <div class="custom-table__cell">' +
            ...
            '       <div class="upload-answer">'+
            '           <div class="input-group">'+
            '                <input id="filename_' + chaterId + '_' + qustionId + '_'+ items[0] +'" type="file" name="filename_' + chaterId + '_' + qustionId + '_'+ items[0] +'" class="test-answer">'+
            '               <label for="filename_' + chaterId + '_' + qustionId + '_'+ items[0] +'"><img class="upload-image" src="../../../img/corp/icons/download-arrow_blue.png"></label>'+
            '           </div>'+
            '            <a href="#" title="Delete" class="delete-test-questions-item">'+
            '                <img src="../../../img/corp/icons/trash.png" alt="Delete">'+
            '            </a>'+
            ...
            '       <div class="upload-answer">'+
            '            <div class="input-group">'+
            '                <input id="filename_' + chaterId + '_' + qustionId + '_'+ items[1] +'" type="file" name="filename_' + chaterId + '_' + qustionId + '_'+ items[1] +'" class="test-answer">'+
            '               <label for="filename_' + chaterId + '_' + qustionId + '_'+ items[1] +'"><img class="upload-image" src="../../../img/corp/icons/download-arrow_blue.png"></label>'+
            '           </div>'+
            '            <a href="#" title="Delete" class="delete-test-questions-item">'+
            '                <img src="../../../img/corp/icons/trash.png" alt="Delete">'+
            '            </a>'+
        ...
        function changeTypeQuestionCourseTest(section,question,items, chapterId, qustionId, thisEl){
            ...
            if ($(thisEl).val() == 0)
            {
                newQuestion =
                    ...
                    '       <div class="upload-answer">'+
                    '           <div class="input-group">'+
                    '                <input id="filename_' + chapterId + '_' + qustionId + '_'+ items[0] +'" type="file" name="filename_' + chapterId + '_' + qustionId + '_'+ items[0] +'" class="test-answer">'+
                    '               <label for="filename_' + chapterId + '_' + qustionId + '_'+ items[0] +'"><img class="upload-image" src="../../../img/corp/icons/download-arrow_blue.png"></label>'+
                    '           </div>'+
                    '            <a href="#" title="Delete" class="delete-test-questions-item">'+
                    '                <img src="../../../img/corp/icons/trash.png" alt="Delete">'+
                    '            </a>'+
                    ...
                    '       <div class="upload-answer">'+
                    '            <div class="input-group">'+
                    '                <input id="filename_' + chapterId + '_' + qustionId + '_'+ items[1] +'" type="file" name="filename_' + chapterId + '_' + qustionId + '_'+ items[1] +'" class="test-answer">'+
                    '               <label for="filename_' + chapterId + '_' + qustionId + '_'+ items[1] +'"><img class="upload-image" src="../../../img/corp/icons/download-arrow_blue.png"></label>'+
                    '           </div>'+
                    '        <a href="#" title="Delete" class="delete-test-questions-item">'+
                    '            <img src="../../../img/corp/icons/trash.png" alt="Delete">'+
                    '        </a>'+
            ...
            if ($(thisEl).val() == 2) {
                newQuestion =
                    ...
                    '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" name="questionscaledescr_' + chapterId + '_' + qustionId + '_'+ items[0] +'" id="questionscaledescr_' + chapterId + '_' + qustionId + '_'+ items[0] +'">' +
                    ...
                    '    <input type="text" class="input-shdw answer" placeholder="Подпись (необязательно)" name="questionscaledescr_' + chapterId + '_' + qustionId + '_'+ items[1] +'" id="questionscaledescr_' + chapterId + '_' + qustionId + '_'+ items[1] +'">' +
