jQuery(function ($) {
    $(document).ready(function () {
        ...
        $('main ').on('change', '.vac-settings__block input[type=checkbox]', function () {
            if($(this).parents('.tools-title').siblings('.vac-settings__block-content').is(':visible')) {
                $(this).parents('.tools-title').siblings('.certification-top-content').fadeOut(300);
                $(this).parents('.tools-title').siblings('.vac-settings__block-content').fadeOut(300);
            } else {
                $(this).parents('.tools-title').siblings('.certification-top-content').fadeIn(300);
        ...
        $('.test-edit').on('click', '.test-edit__name', function(e){
            e.preventDefault();
            $(this).toggleClass('active');
            ...
            $(this).parents('.custom-table__row').find('.custom-table__cell:nth-of-type(3)').toggleClass('closed');
            $(this).parents('.custom-table__row').find('.custom-table__cell:nth-of-type(4)').toggleClass('opened');
            $(this).parents('.custom-table__row').find('.custom-table__cell:nth-of-type(4)').toggleClass('closed');
        });
        $('.test-edit .test-edit__name').parents('.custom-table__row').find('.custom-table__cell:nth-of-type(3)').addClass('closed');
        $('.test-edit .test-edit__name').parents('.custom-table__row').find('.custom-table__cell:nth-of-type(4)').addClass('closed');
        ...
        $('.public-link-checkbox').change(function() {
            if($(this).is(':checked')) {
        ...
        $('.reg-ban-checkbox').change(function() {
            if($(this).is(':checked')) {
                $(this).parents('.design-content__row').find('.link-input').fadeOut(300);
            } else {
                $(this).parents('.design-content__row').find('.link-input').fadeIn(300);
        ...
        $('textarea').keyup(function() {
            let characterCount = $(this).val().length,
                currentCount = $(this).parents('.input-group').find('.current-count');
        ...
        //resize textarea 
        $('main').on('keyup, change, cut, paste, drop, keydown', 'textarea[name*="testdecr_"]', function(){
            console.log(this);
