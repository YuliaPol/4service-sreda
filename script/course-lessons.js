jQuery(function ($) {
    $(document).ready(function () {
        ...
        $('.vacancy-settings').on('click', '.add-new-youtube-link', function () {
            ...
            input.type = "text";
            input.className = "input-shdw"; // set the CSS class
            ...
            input.style = 'width: 100%; box-shadow: 0px 5px 13px 2px #e5e5e5;display: block;opacity: 1;height: 40px;';
            container = $(this).prev().find('.youtube-link div');
